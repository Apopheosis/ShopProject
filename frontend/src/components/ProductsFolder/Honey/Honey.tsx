                        ...
                        <div className={styles.honey__content__mainblock}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <img src={(() => {
                                            if (item!.img_url[1] == null) {
                                                return item!.img_url[0]
                                            } else {
                                                return item!.img_url[1]
                                            }
                                        })()}/>
                                        <img src={(() => {
                                            if (item!.img_url[2] == null) {
                                                return item!.img_url[0]
                                            } else {
                                                return item!.img_url[2]
                                            }
                                        })()}/>
                                        <img src={(() => {
                                            if (item!.img_url[3] == null) {
                                                return item!.img_url[0]
                                            } else {
                                                return item!.img_url[3]
                                            }
                                        })()}/>
                                    </div>
                                </div>
